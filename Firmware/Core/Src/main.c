...
int main(void)
{
  ...
  PID_Init(&angle_pid_roll, 0.004f, 0, 5.0f, 0, 0, 0, 200.0f);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, SPI4_CS_Pin|ERROR_Pin|DFU_Pin|ARM_Pin
  ...
  /*Configure GPIO pins : SPI4_CS_Pin ERROR_Pin DFU_Pin ARM_Pin
                           HEARTBEAT_Pin */
  GPIO_InitStruct.Pin = SPI4_CS_Pin|ERROR_Pin|DFU_Pin|ARM_Pin
                          |HEARTBEAT_Pin;
